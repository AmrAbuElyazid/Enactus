...
@section('content')
<div class="container" ng-controller="TeacherFriendshipController" data-ng-init="getPendingRequests()" class="md-padding">
	...
	<div class="col-md-3" ng-repeat="friend in pendingReqests | startFrom:currentPage*pageSize | limitTo:pageSize">
        ...
        <md-button class="md-fab md-primary md-mini" aria-label="Settings" ng-click="acceptFriendRequest(friend.student.id, friend.student)">
